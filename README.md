<!-- The neofetch block MUST stay outside any align="center" wrapper.
     align="center" sets text-align:center, which centres every line of the
     <pre> independently and destroys the shared left edge that monospace
     ASCII art depends on. -->
...
### `marc@github:~$ ./about.sh`

- 📖 Currently learning **Go, Reinforcement Learning, and Networks & Encryption**
- 🌐 Building and shipping across eight web properties — portfolio at **[marcsawaya.info](https://marcsawaya.info)**
- 📫 Dev: **marcmsawaya@icloud.com** · Personal: **marcsawaya2006@gmail.com** — reach out any time

---

### `marc@github:~$ ./leetcode.sh`

<div align="center">

[![LeetCode stats](https://leetcard.jacoblin.cool/marcmsawaya?theme=dark&font=JetBrains%20Mono&ext=heatmap)](https://leetcode.com/u/marcmsawaya/)

</div>

---

### `marc@github:~$ ./stack.sh`
...
### `marc@github:~$ ./links.sh`

<div align="center">

[![Portfolio](https://img.shields.io/badge/PORTFOLIO-marcsawaya.info-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://marcsawaya.info) [![LeetCode](https://img.shields.io/badge/LEETCODE-marcmsawaya-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/u/marcmsawaya/) [![Email](https://img.shields.io/badge/GET%20IN%20TOUCH-marcmsawaya@icloud.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:marcmsawaya@icloud.com)
